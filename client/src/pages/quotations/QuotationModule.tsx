      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 flex-shrink-0">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Generate proposals, manage pricing packages, and track quotation
            histories
          </p>
        </div>
        {view === "list" && (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right space-x-2">
                          <button
                            onClick={() =>
                              window.open(
                                `${api.defaults.baseURL}/quotations/${quote._id}/pdf`,
                                "_blank",
                              )
                            }
                          ...
                          <button
                            onClick={() => {
                              ...
                              window.open(
                                `https://api.whatsapp.com/send?phone=91${quote.customerPhone}&text=${encodeURIComponent(text)}`,
                                "_blank",
                              );
                            }}
                  ...
                  {(!quotations || quotations.length === 0) &&
                    !isQuotationsLoading && (
                      <tr>
                        ...
                        >
                          <ClipboardList
                            className="mx-auto mb-2 opacity-20 text-gray-400"
                            size={36}
                          />
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-6 overflow-hidden">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Select from inquiries or CRM leads to auto-fill details
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Manually key-in a new customer billing profile from
                        scratch
                      </p>
                    </div>
                  </div>
                      ...
                      {filteredLeads?.map((lead) => (
                        ...
                        >
                          ...
                          <div className="text-right">
                            <span className="px-2 py-0.5 bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-400 rounded-full font-semibold">
                              {lead.productName}
                            </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-850 p-4 rounded-xl space-y-2">
                  <div className="flex items-center gap-1.5 text-emerald-700 dark:text-emerald-400 font-bold text-xs">
                    <RefreshCw size={14} className="animate-pulse" /> Load from
                    Quotation Master (Templates)
                  </div>
                  <select
                  ...
                  >
                    <option value="">
                      -- Choose a pre-defined master package template --
                    </option>
                    {masters?.map((m) => (
                  ...
                  <p className="text-[10px] text-gray-400">
                    Selecting a master auto-populates the item list below. You
                    can still modify any of the amounts or descriptions.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between border-t border-gray-100 dark:border-zinc-800 pt-4">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span
                        className="text-xs text-gray-700 dark:text-gray-300 font-semibold cursor-pointer"
          ...
          <div className="w-full lg:w-96 bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800 p-6 flex flex-col justify-between overflow-y-auto">
            <div>
              ...
              <div className="border border-gray-100 dark:border-zinc-800 rounded-lg p-4 bg-gray-50/50 dark:bg-zinc-950/20 text-[10px] space-y-4">
                <div className="text-center pb-2 border-b border-gray-200 dark:border-zinc-800/80">
                  <h4 className="font-extrabold text-xs text-gray-900 dark:text-white tracking-widest uppercase">
                    Gabha Studio
                  </h4>
                  <p className="text-gray-400 text-[8px] mt-0.5">
                    Art Gallery & Art Services
                  </p>
                </div>

                <div className="flex justify-between items-start gap-4">
                  <div>
                    <span className="font-bold text-gray-400 uppercase block text-[8px]">
                  ...
                  {items.map((item, idx) => (
                    ...
                    >
                      <span className="truncate max-w-[180px]">
                        {item.description || "New service item"}
                      </span>
            ...
            <div className="mt-6 p-3 bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30 rounded-lg text-[10px] text-amber-800 dark:text-amber-300 leading-relaxed">
              <strong>PDF Generation Note:</strong> Saving a proposal generates
              a professional signature-ready letterhead PDF suitable for instant
              sharing.
            </div>
          </div>
        </div>
